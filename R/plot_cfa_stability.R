plot_cfa_stability <- function(resultados,
  ...
  p5 <- ggplot(RMSEA_stability, aes(x = Porcentaje, y = RMSEA, group = 1)) +
    geom_line() +
    geom_point() +
  ...
  p6 <- ggplot(SRMR_stability, aes(x = Porcentaje, y = SRMR, group = 1)) +
    geom_line() +
    geom_point() +
  ...
  p7 <- ggplot(CRMR_stability, aes(x = Porcentaje, y = CRMR, group = 1)) +
    geom_line() +
    geom_point() +
  ...
  p8 <- ggplot(reliability_stability, aes(x = Porcentaje, y = reliability, group = 1)) +
    geom_line() +
    geom_point() +
  ...
  figure3 <- suppressWarnings(ggarrange(p4, p5, p6, p7, p8,
                                        labels = c("A", "B", "C", "D", "E"),
