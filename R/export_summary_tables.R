export_summary_tables <- function(summary_Tabla_Total,
  ...
  openxlsx::writeData(wb, "Resumen_Tablas", t(header1),
  ...
  openxlsx::writeData(wb, "Resumen_Tablas", t(header2),
                      startRow = 2, startCol = 1,
                      colNames = FALSE, rowNames = FALSE)

  # Datos
  openxlsx::writeData(wb, "Resumen_Tablas", df_merged,
